(() => {
    ...
    class SelectConstructor {
        ...
        getSelectElementContent(selectOption) {
            ...
            const selectOptionDataHTML = selectOptionData.indexOf("img") >= 0 ? `<img src="${selectOptionData}" alt="Картинка">` : selectOptionData;
    ...
    (function() {
        ...
        if (null === catalogSection) return;
        var removeChildren = function(item) {
            while (item.firstChild) item.removeChild(item.firstChild);
        };
        var updateChildren = function(item, children) {
            removeChildren(item);
            for (var i = 0; i < children.length; i += 1) item.appendChild(children[i]);
        };
        ...
        catalogNav.addEventListener("click", (function(e) {
            ...
            if (null === item || item.classList.contains("is-active")) return;
            console.log(target);
            e.preventDefault();
            ...
            for (var i = 0; i < catalogItems.length; i += 1) {
                ...
                if (current.getAttribute("data-category") === filterValue) filteredItems.push(current);
            }
